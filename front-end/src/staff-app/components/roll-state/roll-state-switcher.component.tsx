...
export const RollStateSwitcher: React.FC<Props> = ({ initialState = "unmark", size = 40, onStateChange, changeStudentRollState, studentId }) => {
  ...
  const onClick = () => {
    ...
    changeStudentRollState(studentId, next)
  }
